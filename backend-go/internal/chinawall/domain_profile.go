...
var DefaultProfiles = []*DomainProfile{
	{
		...
		// WHY 0.25: DSA principles transfer to new problems.
		// A chunk about "two pointers" is relevant to a new sliding window
		// question even at lower cosine similarity. 0.35 was too strict.
		RerankerThreshold: 0.25,
	},
	{
		Domain:            "algorithms",
		Gate1Skip:         true,
	...
	},
	{
		...
		// WHY 0.28: system design principles transfer (like DSA) but
		// slightly stricter because design decisions are more context-specific.
		RerankerThreshold: 0.28,
	},
	{
		Domain:            "coding",
		Gate1Skip:         true,
	...
	},
	{
		...
		DomainKeywords:  []string{},
		// WHY 0 (use config default 0.35): medical facts must be in transcript.
		// No threshold relaxation for factual domains.
		RerankerThreshold: 0,
	},
	{
		Domain:            "finance",
